...
function Form({ route, method }) {
  ...
  const formTitle = method === "login" ? "Login" : "Add user";
  ...
  return (
    <div className="form-wrapper">
        ...
        <form onSubmit={handleSubmit} className="form-container">
            ...
            {method === "register" && (
                <p className="input-hint" style={{ width: '100%', marginBottom: '15px', color: '#bdc1c6' }}>
            ...
            <div className="form-field">
                ...
                />
                 {method === "register" && (
                    <>
                        <p className="input-hint">Your password can’t be too similar to your other personal information.</p>
                        <p className="input-hint">Your password must contain at least 8 characters.</p>
                        <p className="input-hint">Your password can’t be a commonly used password.</p>
                        <p className="input-hint">Your password can’t be entirely numeric.</p>
                    </>
                )}
            </div>
            ...
            <div className="form-button-container">
                {method === "login" && (
                    <>
                        ...
                        <button className="form-button" type="button" onClick={() => navigate("/register")} disabled={loading}> Create Account </button>
                    </>
                )}
                {method === "register" && (
                    <>
                         <button className="form-button" type="button" onClick={() => navigate("/login")} disabled={loading}> Back to Login </button>
