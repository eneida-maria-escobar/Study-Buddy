...
function Flashcards() {
  ...
  const [activeMode, setActiveMode] = useState("study"); // 'study', 'manage'
  const [manageViewMode, setManageViewMode] = useState("list"); // 'list', 'form' (used within manage mode)
    ...
    const renderStudyMode = () => (
        <div className="flashcard-study-mode">
             <div className="flashcard-top-controls">
                ...
                <button className="fc-button fc-button-mark-hard" onClick={handleMarkHard} disabled={totalCards === 0}>Mark as Hard</button>
                <button className="fc-button fc-button-mark-easy" onClick={handleMarkEasy} disabled={totalCards === 0}>Mark as Easy</button>
            ...
            <div className="flashcard-display-area">
                <div className={`card-content-wrapper ${isCardAnimating ? 'fade-out' : 'fade-in'}`}>
                    {!loading && totalCards === 0 && !error && (
                        <p className="no-flashcards-message">No flashcards available for this module.</p>
                    )}
    ...
    <div className="flashcards-page-container">
        <div className="page-header">
            ...
            <div className="view-mode-toggle">
                 ...
                 <button className={`fc-button ${activeMode === 'manage' ? 'fc-button-primary active' : 'fc-button-secondary'}`} onClick={() => setActiveMode('manage')}> Manage Cards </button>
